...
#header
header = Div(text="""<h1>REALTOR.CA APP STORE & GOOGLE PLAY STORE REVIEWS CLUSTERING</h1>""")
...
description_search = Div(text="""<h3>Filter by Text:</h3><p1>Search keyword to filter out the plot. It will search all reviews including this keyword. Press enter when ready.
...
Slide back to Cluster #20 to show all.</p1>""")
